//Sat Jun 29 2024 15:27:23 GMT+0000 (Coordinated Universal Time)
...
function bdy_0x45ba4d() {
  ...
  return new Promise(_0x5077fa => {
    $.post(_0x7e5546, async (_0x351022, _0x563215, _0x47737c) => {
      try {
        if (!_0x351022) {
          if (_0x47737c) {
...
function bdy_0x864513() {
  return new Promise(_0x4ca14b => {
    ...
    $.get(_0x2fd31e, (_0x4a12a8, _0x986bf8, _0xa1f943) => {
      try {
        if (_0xa1f943) {
